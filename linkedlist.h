...
typedef struct LinkedListInt {
    ...
    void (*addAll)(struct LinkedListInt* list, void* source);
...
typedef struct LinkedListDouble {
    ...
    void (*addAll)(struct LinkedListDouble* list, void* source);
...
typedef struct LinkedListStr {
    ...
    void (*addAll)(struct LinkedListStr* list, void* source);
